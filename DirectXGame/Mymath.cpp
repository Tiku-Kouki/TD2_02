...
Matrix4x4 MakeAffineMatrix(const Vector3& scale, const Vector3& rot, const Vector3& translate) {
	...
	Matrix4x4 matRotXYZMatrix = Multiply(matRotX, Multiply(matRotY, matRotZ));
	Matrix4x4 result;
	result.m[0][0] = scale.x * matRotXYZMatrix.m[0][0];
	result.m[0][1] = scale.x * matRotXYZMatrix.m[0][1];
	result.m[0][2] = scale.x * matRotXYZMatrix.m[0][2];
	result.m[0][3] = 0.0f;

	result.m[1][0] = scale.y * matRotXYZMatrix.m[1][0];
	result.m[1][1] = scale.y * matRotXYZMatrix.m[1][1];
	result.m[1][2] = scale.y * matRotXYZMatrix.m[1][2];
	result.m[1][3] = 0.0f;

	result.m[2][0] = scale.z * matRotXYZMatrix.m[2][0];
	result.m[2][1] = scale.z * matRotXYZMatrix.m[2][1];
	result.m[2][2] = scale.z * matRotXYZMatrix.m[2][2];
	result.m[2][3] = 0.0f;
